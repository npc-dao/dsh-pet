window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region lib/types/pet-endpoints.js
		...
		*/
		...
		//#endregion
		//#region lib/types/client/catalog-store.js
		...
		*/
		...
		//#endregion
		//#region lib/types/client/PetOverlayRoot.js
		...
		*/
		...
		//#endregion
		//#region lib/types/pet-settings.js
		...
		//#endregion
		//#region lib/types/pet-contract.js
		...
		*/
		...
		//#endregion
		//#region lib/types/client/PetSprite.js
		...
		*/
		...
		//#endregion
		//#region lib/types/client/PetOverlay.js
		...
		*/
		function PetOverlay({ descriptor, state, size, reducedMotion }) {
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsx)("div", {
					...
					style,
					tabIndex: 0,
					children: (0, react_jsx_runtime.jsx)(PetSprite, {
		...
		//#endregion
		//#region lib/types/client/pet-state.js
		...
		*/
		...
		//#endregion
		//#region lib/types/client/PetOverlaySlot.js
		/**
		...
		*/
		function PetOverlaySlot({ usePetCatalog, usePetSettings, useReducedMotion, useSession, useSessions }) {
			...
			return (0, react_jsx_runtime.jsx)(PetOverlay, {
				descriptor: {
					...descriptor,
		...
		//#endregion
		//#region lib/types/client/PetsSection.js
		...
		function PetGroup({ heading, pets, revision, selectedId, select, t, writable, empty }) {
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsx)("h3", {
					...
					children: heading
				}), pets.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
							...
							children: (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [
									(0, react_jsx_runtime.jsx)("span", {
										...
										children: pet.available ? (0, react_jsx_runtime.jsx)(PetSprite, {
										...
										children: [
											(0, react_jsx_runtime.jsxs)("span", {
												...
												children: [
													...
													!pet.available && (0, react_jsx_runtime.jsx)("span", {
		...
		*/
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("p", {
						...
						children: [
							t("importPrefix"),
							" ",
							(0, react_jsx_runtime.jsx)("code", { children: "$CODEX_HOME/pets" }),
							" ",
							"(",
							t("importDefault"),
							" ",
							(0, react_jsx_runtime.jsx)("code", { children: "~/.codex/pets" }),
							")",
							t("importSuffix")
						]
					}),
					(status === "idle" || busy && initialLoad) && (0, react_jsx_runtime.jsx)("p", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("label", {
							...
							children: [(0, react_jsx_runtime.jsxs)("span", {
								...
								children: [(0, react_jsx_runtime.jsx)("span", { children: t("size") }), (0, react_jsx_runtime.jsx)("output", { children: petLocaleValue(t("pixels"), "size", String(boundedSize)) })]
					...
					(0, react_jsx_runtime.jsx)(PetGroup, {
		...
		//#endregion
		//#region lib/types/client/PetsSettingsSlot.js
		/**
		...
		*/
		function PetsSettingsSlot({ usePetCatalog, usePetSettings, refresh, set, t }) {
			...
			return (0, react_jsx_runtime.jsx)(PetsSection, {
				catalog: {
					pets: catalog.pets,
					revision: catalog.revision
				},
		...
		//#endregion
		//#region lib/types/client/reduced-motion-store.js
